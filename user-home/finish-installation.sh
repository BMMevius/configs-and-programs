...
git clone git@github.com:zsh-users/zsh-syntax-highlighting.git "${ZSH_CUTOM:-$HOME/.oh-my-zsh/custom}"/plugins/zsh-syntax-highlighting
git clone https://github.com/bilelmoussaoui/flatpak-zsh-completion "${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}"/plugins/flatpak
